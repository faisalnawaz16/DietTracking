        ...
        btnSignIN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (emailID.isEmpty()) {
                    ...
                    authFirebase.createUserWithEmailAndPassword(emailID,pwd).addOnCompleteListener(Login_Signup.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                Toast.makeText(Login_Signup.this,"SignUp Unsuccessful, Please Try Again",Toast.LENGTH_SHORT).show();
                            }
                            else {
                    ...
                    Toast.makeText(Login_Signup.this,"There is some error please Try Again",Toast.LENGTH_LONG).show();
                }
            }
        });
